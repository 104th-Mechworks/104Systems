...
class MainButtonsView(discord.ui.View):
    ...
    @discord.ui.button(
        label="Rules", style=discord.ButtonStyle.blurple, custom_id="rules1"
    )
    async def rules1(self, button: discord.ui.Button, interaction: discord.Interaction):
        embed = discord.Embed(
            title="**104th Battalion Rules**",
            description="Please select the set of rules to view",
            color=0x838181,
        )
        view = RulesSelect()
    ...
    @discord.ui.button(
        label="Ranks", style=discord.ButtonStyle.blurple, custom_id="ranks1"
    )
    async def ranks1(self, button: discord.ui.Button, interaction: discord.Interaction):
        embed = discord.Embed(
            title="**104th Battalion Ranks**",
            description="Please select the set of ranks to view",
            color=0x838181,
        )
    ...
    @discord.ui.button(
        label="Class Info", style=discord.ButtonStyle.blurple, custom_id="classes1"
    )
    async def classes1(
        self, button: discord.ui.Button, interaction: discord.Interaction
    ):
        embed = discord.Embed(
            title="**104th Battalion Classes**",
            description="Please select the set of classes to view",
            color=0x838181,
        )
        view = ClassesSelect()
        await interaction.response.send_message(embed=embed, view=view, ephemeral=True)
    ...
    @discord.ui.button(
        label="Positions", style=discord.ButtonStyle.blurple, custom_id="positions1"
    )
    async def positions1(
        self, button: discord.ui.Button, interaction: discord.Interaction
    ):
        embed = discord.Embed(
            title="**104th Battalion Positions**",
            description="Please select the set of positions to view",
            color=0x838181,
        )
        view = PositionsInfo()
        await interaction.response.send_message(embed=embed, view=view, ephemeral=True)
...
class PositionsInfo(discord.ui.View):
    ...
    @discord.ui.select(
        ...
        options=[
            ...
            discord.SelectOption(
                label="Company Non-Commissioned Officer", value="HCNCO"
            ),
            ...
            discord.SelectOption(
                label="Platoon Non-Commissioned Officer", value="HPNCO"
            ),
    ...
    async def select_callback(self, select, interaction: discord.Interaction):
        ...
        if select.values[0] == "MCCO":
            ...
            embed = discord.Embed(
                title="Platoon Non-Commissioned",
...
class PositionsInfoBack(discord.ui.View):
    ...
    async def button_one_callback(self, button, interaction):
        view = PositionsInfo()
        embed = discord.Embed(
            title="Platoon Position Information",
            description="Select a position to learn more about it.",
            color=discord.Color.from_rgb(105, 103, 103),
        )
        await interaction.response.edit_message(embed=embed, view=view)
...
class YwingOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="Back", style=discord.ButtonStyle.red, custom_id="ywingback"
    )
    async def back(self, button: discord.ui.Button, interaction: discord.Interaction):
        embed = discord.Embed(
            title="**104th Battalion Classes**",
...
class ARFOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="AT-RT Driver", style=discord.ButtonStyle.blurple, custom_id="atrt"
    )
...
class OfficerOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="Naval Officer", style=discord.ButtonStyle.blurple, custom_id="NO"
    )
    async def navyoff(
        self, button: discord.ui.Button, interaction: discord.Interaction
    ):
    ...
    @discord.ui.button(
        label="104th Officer", style=discord.ButtonStyle.blurple, custom_id="IO"
    )
...
class SpecialistOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="Marksman", style=discord.ButtonStyle.blurple, custom_id="Sman"
    )
...
class HeavyPageOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="Anti-Armour", style=discord.ButtonStyle.blurple, custom_id="Aman"
    )
...
class AntiArmourOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="TX-130 Driver", style=discord.ButtonStyle.blurple, custom_id="TX130"
    )
...
class AssaultPageOptions(discord.ui.View):
    ...
    @discord.ui.button(
        label="Rifleman", style=discord.ButtonStyle.blurple, custom_id="Rman"
    )
...
class StaffSelectBack(discord.ui.View):
    ...
    @discord.ui.button(
        label="Back", style=discord.ButtonStyle.red, custom_id="staffRback"
    )
    async def staffrback(
        self, button: discord.ui.Button, interaction: discord.Interaction
    ):
        embed = discord.Embed(
            title="**Staff Rules**",
...
class StaffRulesSelect(discord.ui.View):
    ...
    @discord.ui.select(
        options=[
            discord.SelectOption(label="Basics", value="staffbasics"),
            discord.SelectOption(label="Maturity", value="staffroles"),
            discord.SelectOption(label="Consequence", value="staffconsiquence"),
            discord.SelectOption(label="Concerns", value="staffconcerns"),
        ],
        placeholder="Select a set of rules",
    ...
    async def staffrulesselect(self, select, interaction: discord.Interaction):
        ...
        if select.values[0] == "staffbasics":
            ...
            embed = discord.Embed(
                title="**How to deal with concerns**",
                description=f"""
...
class RulesSelect(discord.ui.View):
    ...
    @discord.ui.select(
        options=[
            discord.SelectOption(label="Discord Rules", value="discord"),
            discord.SelectOption(label="In Game", value="ig"),
            discord.SelectOption(label="Milsim", value="milsim"),
    ...
    async def rulesSelect(self, select, interaction: discord.Interaction):
        if select.values[0] == "discord":
            embed = discord.Embed(
                title="**Discord Rules**",
                description="Please read the rules carefully and follow them",
                color=0x838181,
            )
            embed.add_field(name="**1.**", value="No abuse to anyone", inline=False)
            embed.add_field(
                name="**2.**",
                value="No spamming any type of content in the chats (Text, Images and other content.",
                inline=False,
            )
            embed.add_field(
                name="**3.**",
            ...
            embed.add_field(
                name="**8.**",
                value="Do not organize, participate or encourage harassment on others.",
                inline=False,
            )
            embed.add_field(
                name="**9.**",
                value="Do not organize,promote, or coordinate servers around hate speech.",
                inline=False,
            )
            embed.add_field(
                name="**10.**",
                value="Do not make threats of violence or threaten harm to others.",
                inline=False,
            )
            embed.add_field(
                name="**11.**",
                value="Do not evade user blocks or server bans.",
                inline=False,
            )
            embed.add_field(
                name="**12.**",
                value="Do not send other viruses or malware.",
                inline=False,
            )
            embed.add_field(
                name="**13.**",
                value="o not share 3rd party milsim drama here.",
                inline=False,
            )
            embed.add_field(
                name="**14.**",
                value="Do not ping staff for something that isn't serious.",
                inline=False,
            )
            ...
            embed.add_field(
                name="**1.**",
                value="No Shouting down the mic, Communication is key",
                inline=False,
            )
            embed.add_field(
                name="**2.**",
                value=" Phase 2 104th skin for all clones. Phase 1 104th for ARFs.",
                inline=False,
            )
            embed.add_field(
                name="**3.**",
                value="Clone Wars Era Weapons only.",
                inline=False,
            )
            embed.add_field(
                name="**4.**",
            ...
            embed.add_field(
                name="**5.**",
                value="Officer class are for officers only.",
                inline=False,
            )
            embed.add_field(
                name="**6.**",
            ...
            embed.add_field(
                name="**7.**",
                value="No heroes. We are a Clone Unit.",
                inline=False,
            )
            embed.add_field(
                name="**8.**",
                value="BARC Speeder/Republic Gunship is allowed for all members.",
                inline=False,
            )
            embed.add_field(
                name="**9.**",
            ...
            embed.add_field(
                name="**10.**",
                value="Respect the raid leader and others.",
                inline=False,
            )
            embed.add_field(
                name="**11.**",
                value="AT-RT's are only allowed for AT-RT Drivers",
                inline=False,
            )
            embed.add_field(
                name="**12.**",
                value="Qualifications can only be earned on your designated console.",
                inline=False,
            )
            embed.add_field(
                name="**13.**",
            ...
            embed.add_field(
                name="**14.**",
                value="Raid Rules must be followed when playing clones, no matter what",
                inline=False,
            )
            embed.add_field(
                name="**15.**",
...
class MilsimRanksSelect(discord.ui.View):
    ...
    @discord.ui.select(
        placeholder="Choose a ranks list...",
        min_values=1,
        max_values=1,
        custom_id="mainranks",
        options=[
            discord.SelectOption(label="Army Ranks", value="Army"),
            ...
            discord.SelectOption(
                label="Special Operations Brigade Ranks",
                description="path 1",
                value="ARC",
            ),
            discord.SelectOption(
    ...
    async def callback(self, select, interaction: discord.Interaction):
        ...
        if select.values[0] == "Army":
            armyRanksEmbed = discord.Embed(
                title="**Army Ranks**",
                description=">>> This is the list of all Army Ranks.\nThese are active staff members.",
                color=0x6F9911,
            )
            armyRanksEmbed.add_field(
                name="<:CDR:1148647028172275772> Battalion Commander: BCDR",
                value="Commander of the Army.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="<:CDR:1148647028172275772> Clone Commander: CDR",
                value="Commander with a Specific Purpose.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="<:MAJ:1148647158023729232> Major: MAJ",
                value="One Major under the same Console BCDR working to run the consoles functions.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name=" <:CPT:1148647191271985284> Captain: CPT",
                value="In charge of companies and LTs and 2LTs to keep things running smoothly.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="<:LT:1148647473582198924> Lieutenant: LT",
                value="Works under Captain helping with company problems and paperwork.",
                inline=False,
            )
            armyRanksEmbed.add_field(
            ...
            armyRanksEmbed.add_field(
                name=" <:SGM:1148647526648512713> Sergeant Major: SGM",
                value="Sergeant Majors oversee Corporals and Sergeants training them and doing other tasks for Captains or -Lieutenants.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="<:SGT:1148647550006607932> Sergeant: SGT",
                value="Host raids and does jobs along with Corporals.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="<:CPL:1148647578515284070> Corporal: CPL",
                value="Corporals monitors chats, help cadets and hosts raids under Sergeants.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="<:LCPL:1148647599142862858> Lance Corporal: LCPL",
                value="Lance Corporals work with staff but are in training and learn how to become a CPL.",
                inline=False,
            )
            armyRanksEmbed.add_field(
                name="Clone Trooper: CT",
                value=f"Basic Clones who pass from Cadet Hub.",
                inline=False,
            )
            await interaction.response.edit_message(embed=armyRanksEmbed, view=view)
        elif select.values[0] == "Starfighter":
            starfighterRanksEmbed = discord.Embed(
                title="**Starfighter Ranks**",
                description=">>> This is the list of all Starfighter Corps Ranks.\nThese are active staff members.",
                color=0x2F55B4,
            )
            starfighterRanksEmbed.add_field(
                name="<:COM:1148648408949727305> Commodore: COM",
                value=f"Head of the Starfighter Corps",
                inline=False,
            )
            starfighterRanksEmbed.add_field(
                name="<:ACPT:1148648812504682567> Air Captain: CPT",
                value=f"Second in command of the Starfighter Corps.",
                inline=False,
            )
            starfighterRanksEmbed.add_field(
                name="<:WCDR:1148648539971407952> Wing Commander: WCDR",
            ...
            starfighterRanksEmbed.add_field(
                name="<:GCPT:1148648504076546178> Group Captain: GCPT",
            ...
            starfighterRanksEmbed.add_field(
                name="<:SL:1148648522061721752> Squadron Leader: SL",
            ...
            starfighterRanksEmbed.add_field(
                name="<:FCPT:1148648436351115398> Flight Captain: FCPT",
            ...
            starfighterRanksEmbed.add_field(
                name="<:FLT:1148648458056630333> Flight Lieutenant: FLT",
            ...
            starfighterRanksEmbed.add_field(
                name=" <:FO:1148648483797094500> Flight Officer: FO",
                value=f"Flight Officers work with staff but are in training to learn how to become a FLT.",
                inline=False,
            )
            starfighterRanksEmbed.add_field(
                name="Pilot Officer: PO",
                value=f"Basic Clones within a wing.",
                inline=False,
            )
            await interaction.response.edit_message(
                embed=starfighterRanksEmbed, view=view
            )
        elif select.values[0] == "Auxiliary Unit":
            auxiliaryUnitRanksEmbed = discord.Embed(
                title="**Auxiliary Unit Ranks**",
            ...
            auxiliaryUnitRanksEmbed.add_field(
                name="<:NCDR:1148648069911560263> Naval Commander: NCDR",
                value=f"Retired CPT/MAJ",
                inline=False,
            )
            auxiliaryUnitRanksEmbed.add_field(
                name="<:LTCDR:1148648093647130644> Lieutenant Commander: LTCDR",
                value=f"Retired LT",
                inline=False,
            )
            auxiliaryUnitRanksEmbed.add_field(
                name="<:NLT:1148648121979645992> Naval Lieutenant: NLT",
                value=f"Retired 2LT",
                inline=False,
            )
            auxiliaryUnitRanksEmbed.add_field(
                name="<:PO1:1148648158218424401> Petty Officer 1st Class: PO1",
                value=f"Retired SGM",
                inline=False,
            )
            auxiliaryUnitRanksEmbed.add_field(
                name="<:PO2:1148648184617390151> Petty Officer 2nd Class: PO2",
                value=f"Retired SGT",
                inline=False,
            )
            auxiliaryUnitRanksEmbed.add_field(
                name="<:PO3:1148648205366599702> Petty Officer 3rd Class: PO3",
                value=f"Retired CPL",
                inline=False,
            )
            await interaction.response.edit_message(
                embed=auxiliaryUnitRanksEmbed, view=view
            )
        elif select.values[0] == "Fleet Command":
            fleetCommandRanksEmbed = discord.Embed(
                title="**Fleet Command Ranks**",
                description=">>> This is the list of all Fleet Command Ranks.",
                color=0xD13135,
            )
            fleetCommandRanksEmbed.add_field(
                name=f"<:MCDR:1148646287512707172> Marshal Commander: MCDR",
                value=f"Commander of the 104th Fleet.",
                inline=False,
            )
            fleetCommandRanksEmbed.add_field(
                name="<:SCDR:1148646978385887232> Senior Commander: SCDR",
            ...
            arcRanksEmbed = discord.Embed(
                title="**Special Operations Brigade Ranks Path 1**",
                description=">>> This is the list of all ARC Ranks.",
                color=0xEC0AC6,
            )
            ...
            rcRanksEmbed = discord.Embed(
                title="**Special Operations Brigade Ranks Path 2**",
                description=">>> This is the list of all RC Ranks.",
                color=0x02D9F8,
            )
            rcRanksEmbed.add_field(
                name="<:RCCDR:1148649110333816932> Republic Commando Commander: CDR",
                value=f"Program Admissions Officer",
                inline=False,
            )
            rcRanksEmbed.add_field(
                name="Republic Commando Officers:",
                value=f"Possible to become any army officer rank with undisclosed jobs.",
                inline=False,
            )
            rcRanksEmbed.add_field(
                name="<:RCSGT:1148649323177988156> Republic Commando Sergeant: SGT",
                value=f" Third Rank of the RCs.",
                inline=False,
            )
            rcRanksEmbed.add_field(
                name=f"<:RCCPL:1148649139496828958> Republic Commando Corporal: CPL",
                value=f"Second rank of RCs",
                inline=False,
            )
            rcRanksEmbed.add_field(
                name="<:RCPVT:1148649259353251880> Republic Commando Private: PVT",
                value=f"First Rank of RCs.",
                inline=False,
            )
